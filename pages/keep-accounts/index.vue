	...
	<view class="page">
		...
		<scroll-view class="category-scroll" scroll-y="true" :style="getScrollHeight">
			<view class="tabs-container">
				<view v-for="(item, index) in dataList" :key="index" :class="['category', { active: item._id === activeCategoryId }]"
				 @click="handleKeep(item._id,item.name)">
					<view class="icon-col">
						<view class="icon iconfont" v-html="item.icon"></view>
					</view>
		...
		<!-- 备注面板 -->
		<remark-panel class="remarkp" :visible.sync="isOpenRemarkPanel" :content="remark" @confirm="handleConfirmRemark"
