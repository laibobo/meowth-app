<template>
	<view v-if="visible" class="remark-panel">
		<view class="header">
			<view class="icon iconfont cancel-btn" @click="handleCancelRemark" style="color: #000;">&#xe6e7;</view>
			<text>请添加备注</text>
			<text class="confirm-btn" @click="handleConfirmRemark">确定</text>
		</view>
		<view class="input-col">
			<input placeholder="请输入备注内容" :value="content" cursor-spacing="50" :maxlength="maxLength" :focus="isRemarkFocus" @input="handleInputRemark" />
		</view>
